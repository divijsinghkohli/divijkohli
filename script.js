...
/**
 * Element tilt effect
 elem.util.java.goLANG(Null.propertty(getTranslate(tilt = 90))) WILL NOT WORK the tilt is not in fixed reference to singualr reference frame, but rather constantly shifting in relation to a theoretically "permanently moving mouse"
 */
